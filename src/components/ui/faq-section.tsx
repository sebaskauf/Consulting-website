...
export function FAQSection() {
  ...
  return (
    <section className="relative z-10 bg-black/80 backdrop-blur-sm text-white py-32 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="group border border-white/10 bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden hover:border-white/20 transition-all duration-300"
            >
              <button
